...
class CellCreationHelper {
    ...
    static func cellForMap(tableView: UITableView, indexPath: IndexPath, addressFirstLine : String, addressSecondLine : String) -> UITableViewCell {
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: addressSecondLine, value: addressFirstLine)
        cell.detailImage = FUIIconLibrary.app.campusOn.withRenderingMode(.alwaysTemplate)
