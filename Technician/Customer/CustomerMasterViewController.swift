//
// CustomerMasterViewController.swift
// Technician
//
...
//        UIFunctionsHelper.updateSalesOrderChart(appDelegate: appDelegate, logger: self.logger, completedKPIChart: self.kpiHeader?.items[0] as! FUIKPIProgressView)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: customer.customerID ?? "", value: (customer.firstName ?? "") + " " + (customer.lastName ?? "") )
        return cell
    }
...
extension CustomerMasterViewController: EntitySetUpdaterDelegate {
